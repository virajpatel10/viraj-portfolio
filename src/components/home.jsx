        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                ...
                <motion.h1 
                  ...
                  lg:text-8xl"> Viraj Patel</motion.h1>
                <motion.span 
                ...
                initial="hidden"
                animate="visible"
                className="my-2 max-w-xl py-6 font-light tracking-tighter">{MAIN_CONTENT}
                </motion.p>
                </div>
              </div>
            <div className="w-full lg:w-1/3 lg:p-8 mx-20">
              <div className="flex-justify-center">
                  ...
                  src={profilePic} alt="Viraj Patel" className="rounded-l-lg rounded-r-lg"></motion.img>
              </div>
            </div>  
          </div>
    </div>
